...
public class ChatsFragment extends Fragment {
    ...
    //Typeface nunitotypeface = Typeface.createFromAsset();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //nunitotypeface = Typeface.createFromAsset()
        ...
        if(mAuth.getCurrentUser() != null) {
            ...
            FirebaseRecyclerAdapter<Conv, ConvViewHolder> firebaseConvAdapter = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(
                ...
                protected void populateViewHolder(final ConvViewHolder convViewHolder, final Conv conv, int i) {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            convViewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                                ...
                                public boolean onLongClick(View v) {
                                    CharSequence options[] = new CharSequence[]{"Open Profile", "Delete Conversation"};
                                    ...
                                    builder.setItems(options, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if (i == 0) {
                                                ...
                                                profileIntent.putExtra("user_state", "friends");
                                            ...
                                            if (i == 1) {
                                                ...
                                                /*mConvDatabase.child(list_user_id).setValue(null).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    @Override
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if(task.isSuccessful()){
                                                            Toast.makeText(getContext(), "Deleted Conversation Successfully", Toast.LENGTH_SHORT);
                                                        }
                                                    }
                                                });*/
                    ...
                    //
                    mFriendsDatabase.child(list_user_id).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
