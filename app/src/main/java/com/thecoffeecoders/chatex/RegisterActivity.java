        ...
        mCreateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(password.equals(confirmPassword)){
                    ...
                    Toast.makeText(RegisterActivity.this, "Password and Confirm Password fields do not match",
                            ...
                            current_user.sendEmailVerification()
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                mDatabase.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if(task.isSuccessful()){ //do this only after writing to database
                                                            ...
                                                            verificationIntent.putExtra("email", current_user.getEmail());
                                            ...
                                            if (!task.isSuccessful()) {
                                                mRegProgress.hide();
                                                Toast.makeText(RegisterActivity.this, "Error on registering the user. Please check all details are correct.",
                                                        Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
